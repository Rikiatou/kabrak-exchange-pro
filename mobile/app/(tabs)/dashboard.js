    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.metricsRow}>
          ...
          {isAdmin && <MetricCard label={t.common.unpaid} value={s.unpaidCount || 0} icon="alert-circle" accent="#dc2626" sub={s.unpaidCount > 0 ? '⚠' : null} onPress={() => router.push('/(tabs)/transactions')} />}
